...
<div class="flex w-1/2 flex-col gap-20 skill">
  <div class="flex flex-col items-center gap-6 mt-0.5">
    ...
    <p class="tracking-[0.1em] text-center">
      Nisl suscipit adipiscing bibendum est. Scelerisque viverra mauris in
      aliquam sem fringilla ut morbi tincidunt. Morbi quis commodo odio aenean
      sed adipiscing diam donec. Curabitur gravida arcu ac tortor.
    </p>
  </div>
  <div class="flex flex-col items-center gap-6 mt-0.5">
    <Icon
