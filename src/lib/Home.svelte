...
>
  ...
  <div
    in:fade
    out:fade
    class="fixed pointer-events-none bottom-12 w-full text-center px-8 left-1/2 -translate-x-1/2 text-zinc-100 z-[9999] uppercase text-xs font-light tracking-[0.2em]"
  >
